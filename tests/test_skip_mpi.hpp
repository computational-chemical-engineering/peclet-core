...
// launcher: Open MPI 5's prterun then tears the job down and returns 1 — not the rank's 77 —
// whenever the ranks' exits are not simultaneous (reproduced 2 times in 108 launches under `ctest
