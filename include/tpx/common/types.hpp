...
// negative-inside-solid (enforced in tpx::geom, not here). This header is C++17-clean so it can be
// pulled into CUDA translation units; C++20-only constructs live in host-only headers.
#ifndef TPX_COMMON_TYPES_HPP
#define TPX_COMMON_TYPES_HPP
