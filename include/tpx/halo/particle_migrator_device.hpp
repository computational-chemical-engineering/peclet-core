...
#ifndef TPX_HALO_PARTICLE_MIGRATOR_DEVICE_HPP
#define TPX_HALO_PARTICLE_MIGRATOR_DEVICE_HPP
...
#include "tpx/halo/particle_migrator.hpp"  // DomainMap<Dim>
...
#endif  // TPX_HALO_PARTICLE_MIGRATOR_DEVICE_HPP
